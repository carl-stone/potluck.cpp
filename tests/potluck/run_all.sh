...
for test_bin in test-potluck-discovery test-potluck-protocol test-potluck-probe test-potluck-transport test-potluck-halda test-potluck-qwen35-stages test-potluck-run; do
...
for test_bin in test-potluck-discovery test-potluck-protocol test-potluck-transport test-potluck-halda; do
    printf '== %s ==\n' "${test_bin}"
    "${BIN}/${test_bin}"
done
